...
def _save_embeddings_to_word2vec():
    cbow_net = torch.load('/home/user/Code/NLP/awe-project/awe-data/model-data/kq_dim_50_lr_3e4_dim500_mean_root500_std_dot1_acbow_model_vecto_500_7L_ep2.cbow_net')
    ...
    output_path = os.path.join('/home/user/Code/NLP/awe-project/awe-data/model-data/kq_dim_50_lr_3e4_dim500_mean_root500_std_dot1_acbow_model_vecto_500_7L_ep2_w2v.emb')
