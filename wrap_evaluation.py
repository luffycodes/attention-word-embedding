...
PATH_TO_DATA = '/media/zoro/hdd1/attend-word2vec-data/SentEval-master/data'
...
def _evaluate_downstream_and_probing_tasks(encoder, params, batcher, prepare):
    ...
    if params.downstream_eval == "full":
        ...
        params_senteval = {'task_path': params.path_to_senteval_dir, 'usepytorch': True, 'kfold': 10}
        params_senteval['classifier'] = {'nhid': params.nhid, 'optim': 'adam', 'batch_size': 64,
                                         'tenacity': 5, 'epoch_size': 4}

    elif params.downstream_eval == "test":
        ## for testing purpose
        params_senteval = {'task_path': params.path_to_senteval_dir, 'usepytorch': True, 'kfold': 5}
...
def _add_common_arguments(parser):
    ...
    parser.add_argument("--path_to_senteval_dir", type=str, default='/dataroot/attend-word2vec-data/SentEval-master/data', help="path to fastsent data")
